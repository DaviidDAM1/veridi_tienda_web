      ...
      <section className="pagina-estatica">
        ...
        <div className="content-section">
          ...
          <p>
            ...
            y garantizar que tengas una experiencia segura al utilizar nuestro sitio web y servicios.
            Esta Política de Privacidad explica cómo recopilamos, utilizamos, divulgamos y salvaguardamos
            tu información cuando visitas nuestro sitio web.
          </p>
          <p>
            Por favor, lee esta política cuidadosamente. Si no estás de acuerdo con nuestras políticas
            y prácticas, no utilices nuestro sitio. Al acceder a Veridi, confirmas que has leído
            y comprendido esta Política de Privacidad.
          </p>
        </div>
        ...
        <div className="content-section">
          ...
          <ul className="info-list">
            ...
            <li><strong>Analítica:</strong> Información sobre cómo interactúas con nuestro contenido</li>
          </ul>
        </div>
        ...
        <div className="content-section">
          ...
          <ul className="info-list">
            ...
            <li>Enviar comunicaciones de marketing (si has optado por ello)</li>
            <li>Analizar tendencias y mejorar la funcionalidad del sitio</li>
            <li>Detectar y prevenir actividades fraudulentas y no autorizadas</li>
        ...
        <div className="content-section">
          ...
          <ul className="info-list">
            ...
            <li>Mostrar contenido personalizado y recomendaciones</li>
          </ul>
          <p>
            Puedes controlar las cookies a través de la configuración de tu navegador. Sin embargo,
            deshabilitar ciertas cookies puede afectar la funcionalidad de nuestro sitio.
          </p>
        </div>
        ...
        <div className="content-section">
          ...
          <p>
            A pesar de nuestros esfuerzos, ningún sistema de seguridad es totalmente impenetrable.
        ...
        <div className="content-section">
          ...
          <ul className="info-list">
            ...
            <li><strong>Con Tu Consentimiento:</strong> Compartimos información si nos lo solicitas explícitamente</li>
          </ul>
        </div>
        ...
        <div className="content-section">
          ...
          <ul className="info-list">
            ...
            <li><strong>Derecho a Limitar el Uso:</strong> Puedes restringir cómo usamos tu información</li>
            <li><strong>Derecho a Desuscribirse:</strong> Puedes optar por no recibir comunicaciones de marketing</li>
            <li><strong>Derecho a Portabilidad:</strong> Puedes solicitar tus datos en un formato transferible</li>
          </ul>
          <p>
            Para ejercer estos derechos, contacta con nosotros en <Link to="/contacto">nuestra página de contacto</Link>.
          </p>
        </div>
        ...
        <div className="content-section">
          ...
          <ul className="info-list">
            ...
            <li>Los datos analíticos se conservan durante 12 meses</li>
          </ul>
          <p>
            Eliminaremos o anonimizaremos tus datos cuando ya no sea necesario retenerlos,
            a menos que estemos obligados por ley a mantenerlos.
          </p>
        </div>
        ...
        <div className="content-section">
          ...
          <p>
            ...
            prácticas de privacidad de esos sitios. Te recomendamos leer las políticas de privacidad
            de cualquier sitio tercero antes de proporcionar tu información personal.
          </p>
        </div>
        ...
        <div className="content-section">
          ...
          <p>
            ...
            tecnología, requisitos legales u otros factores. Te notificaremos de cambios materiales mediante
            una actualización visible en el sitio web o por correo electrónico, si es necesario.
          </p>
          <p>
            Tu uso continuado del sitio después de cambios constituye tu aceptación de la política actualizada.
          </p>
        </div>
        ...
        <div className="content-section contact-cta">
          ...
          <p>
            Haremos todo lo posible por responder a tus consultas en el plazo más breve posible.
          </p>
        </div>

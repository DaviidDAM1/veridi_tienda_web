...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      try { if (resizeObserverRef.current) resizeObserverRef.current.disconnect(); } catch (e) { void 0; }
      try { if (intersectionObserverRef.current) intersectionObserverRef.current.disconnect(); } catch (e) { void 0; }

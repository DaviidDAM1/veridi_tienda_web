...
<main>
    <section class="pagina-estatica">
        ...
        <div class="hero-section">
            <h1>Sobre Veridi</h1>
            <p class="hero-subtitle">Lujo, calidad y diseño en cada prenda</p>
        </div>
        ...
        <!-- Compromiso -->
        <div class="content-section commitment">
        ...
        <!-- Por qué elegir Veridi -->
        <div class="content-section why-veridi">
        ...
        <!-- Contacto -->
        <div class="content-section contact-cta">
            <h2>¿Contacta Conmigo?</h2>
            <p>Nos encantaría saber de ti. Si tienes preguntas, sugerencias o simplemente quieres saludar, 
            no dudes en <a href="contacto.php">ponerte en contacto con nosotros</a>.</p>
